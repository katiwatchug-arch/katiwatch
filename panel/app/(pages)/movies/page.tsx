    ...
    <AdminPanelLayout>
      <div className="flex flex-col gap-4 mb-6 px-4 sm:px-0">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white uppercase tracking-wider">Movies (Reelplexi Catalog)</h1>
            <p className="text-xs text-gray-400 mt-1">Live movie catalog from Reelplexi API — pick any movie to send push notifications</p>
          </div>
            ...
            {loading ? (
              <tr>
                <td colSpan={6} className="px-6 py-12 text-center text-gray-400 font-bold uppercase tracking-wider">
                  Loading movies from Reelplexi API...
                </td>
              </tr>
            ) : movies.length === 0 ? (
              <tr>
